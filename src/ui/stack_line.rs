...
mod tests {
    ...
    fn test_segment_click_detection() {
        ...
        assert_eq!(
            GroupIndicatorWindow::segment_at_point_static(
        ...
        let bounds = CGRect::new(CGPoint::new(0.0, 0.0), CGSize::new(200.0, 200.0));
