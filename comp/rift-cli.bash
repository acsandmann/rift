_rift-cli() {
    ...
    case "${cmd}" in
        rift__cli)
            opts="-h --help query execute subscribe service help"
        ...
        rift__subcmd__cli__subcmd__execute__subcmd__help__subcmd__window)
            opts="next prev focus toggle-float toggle-fullscreen toggle-fullscreen-within-gaps resize-grow resize-shrink resize-by close"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rift__subcmd__cli__subcmd__execute__subcmd__window)
            opts="-h --help next prev focus toggle-float toggle-fullscreen toggle-fullscreen-within-gaps resize-grow resize-shrink resize-by close help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rift__subcmd__cli__subcmd__execute__subcmd__window__subcmd__help)
            opts="next prev focus toggle-float toggle-fullscreen toggle-fullscreen-within-gaps resize-grow resize-shrink resize-by close help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rift__subcmd__cli__subcmd__help)
            opts="query execute subscribe service help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
